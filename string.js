const myName ="Alka-Rao-Learning-js"
const repoCount = 90;
// console.log(name +repoCount+"Values");//not recommended to use 
...
//  console.log(myName.toUpperCase());ALKA-RAO_LEARNING_JS-ERROR
 ...
 console.log(myName.substring(0,4));//Alka
 console.log(myName.slice(0,4));//Alka
