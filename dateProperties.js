...
// console.log(mydate.toISOString());//2023-11-25T01:27:11.200Z :return string in this format.
// console.log(mydate.toJSON());//2023-11-25T01:27:11.200Z//return string representing this date in same format as toISOString()
// console.log(mydate.toLocaleDateString());//11/25/2023
// console.log(mydate.toLocaleString());//11/25/2023, 6:57:11 AM
// console.log(mydate.toLocaleTimeString());//6:57:11 AM
// console.log(mydate.toTimeString());//06:57:11 GMT+0530 (India Standard Time)
// console.log(mydate.toUTCString());//Sat, 25 Nov 2023 01:27:11 GMT
// console.log(new Date(2023 ,0,25));
// console.log(new Date(2023,0,25,7,11));
// console.log(new Date("2023-01-14"));
// console.log(Date.UTC());//NaN
// console.log(Date.apply());//Sat Nov 25 2023 07:26:23 GMT+0530 (India Standard Time)
// console.log(Date.arguments());//error
// console.log(Date.bind());//error
// console.log(Date.call());//Sat Nov 25 2023 07:30:32 GMT+0530 (India Standard Time)
// console.log(Date.caller());//error
// console.log(Date.length());//error
// console.log(Date.name());//error
// console.log(Date.parse());//NaN
// console.log(Date.now());//1700877383815
// console.log(Date.now()/1000);//1700877904.104
// const prstDate = new Date("2023-11-25");
